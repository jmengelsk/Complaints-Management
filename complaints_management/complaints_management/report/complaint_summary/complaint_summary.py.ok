...
# {%= fmt_money(data[i][__("cn_amount")], currency = data[i][__("cn_currency")] ) %}
                total_c = []
                total_c = 'EUR'
                total_f = []
                total_f = frappe.utils.fmt_money(sum(sumcn[0]), currency = total_c)
                data.append(['','','','','','',total_f,total_c,''])
...
def get_pfilsum(filters):
        pfilsum = ""
        if filters.get("product_filter"): pfilsum = "and pfilter = %(product_filter)s"
        return pfilsum
...
def get_complaints_en(filters):
    ...
    """select cpldate, cplnr, customer, complaint, product, approval_by, cn_amount, cn_currency, status, apfilter, pfilter, rcfilter from
       (select cpldate, cplnr, customer, complaint, product, approval_by, cn_amount, cn_currency, status, apfilter, pfilter, rcfilter from
        (select cpldate, cplnr, customer, complaint, product, approval_by, cn_amount, cn_currency, status, apfilter, pfilter, rcfilter from
           (select cpldate,
                   name as cplnr,
                   ...
                   item1_approval_by as approval_by,
                   item1_cn_amount as cn_amount,
                   item1_cn_currency as cn_currency,
           ...
           select cpldate,
                   ...
                   item2_approval_by as approval_by,
                   item2_cn_amount as cn_amount,
                   item2_cn_currency as cn_currency,
                   complaint_status as status,
           ...
           select cpldate,
                   ...
                   item3_approval_by as approval_by,
                   item3_cn_amount as cn_amount,
                   item3_cn_currency as cn_currency,
                   complaint_status as status,
           ...
           select cpldate,
                   ...
                   item4_approval_by as approval_by,
                   item4_cn_amount as cn_amount,
                   item4_cn_currency as cn_currency,
                   complaint_status as status,
           ...
           select cpldate,
                   ...
                   item5_approval_by as approval_by,
                   item5_cn_amount as cn_amount,
                   item5_cn_currency as cn_currency,
                   complaint_status as status,
           ...
           select cpldate,
                   ...
                   item6_approval_by as approval_by,
                   item6_cn_amount as cn_amount,
                   item6_cn_currency as cn_currency,
                   complaint_status as status,
